...
veghed_user_rating = matrix['VUADGMPLJoWqhHb1G4LIcA']
NOseafoodsteak = matrix['J9vAdD2dCpFuGsxPIn184w']

similar_to_veghed = matrix.corrwith(veghed_user_rating)
similar_to_NOseafoodsteak = matrix.corrwith(NOseafoodsteak)
